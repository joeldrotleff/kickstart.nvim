...
alias funnel_lspbuild='cd ~/code/joya/funnel && xcode-build-server config -project Funnel.xcodeproj -scheme Funnel'
...
# Added by Windsurf
fish_add_path /Users/joeldrotleff/.codeium/windsurf/bin
