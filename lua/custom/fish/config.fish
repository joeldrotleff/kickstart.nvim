...
alias tofutestlspbuild='cd ~/code/joya/sdr/client/no_backend/ && xcode-build-server config -project *xcodeproj -scheme SDRMobile'
alias tofulspbuild='cd ~/code/joya/sdr/client/real_backend/ && xcode-build-server config -project *xcodeproj -scheme Tofu'
